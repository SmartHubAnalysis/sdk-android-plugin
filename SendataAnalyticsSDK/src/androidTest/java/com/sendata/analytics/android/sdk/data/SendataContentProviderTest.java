...
public class SendataContentProviderTest {
    ...
    public ProviderTestRule mProviderRule =
            new ProviderTestRule.Builder(SendataContentProvider.class, "com.sendata.analytics.android.sdk.test.SendataContentProvider")
                    .build();
