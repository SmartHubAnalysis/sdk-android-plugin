...
package com.sendata.analytics.android.sdk.data;
...
import com.sendata.analytics.android.sdk.PropertyBuilder;
import com.sendata.analytics.android.sdk.data.persistent.PersistentAppEndData;
import com.sendata.analytics.android.sdk.data.persistent.PersistentAppPaused;
import com.sendata.analytics.android.sdk.data.persistent.PersistentAppStartTime;
...
import com.sendata.analytics.android.sdk.data.persistent.PersistentIdentity;
import com.sendata.analytics.android.sdk.data.persistent.PersistentLoader;
import com.sendata.analytics.android.sdk.data.persistent.PersistentLoginId;
...
public class PersistentTest {
    ...
    public void persistentDataTest() {
        SharedPreferences sharedPreferences = context.getSharedPreferences("com.sendata.analytics.android.sdk.SendataAPI", Context.MODE_PRIVATE);
        ...
        sharedPreferences.edit().clear().apply();
        {
            ...
            assertThat(dataStr, allOf(notNullValue(), equalTo(SendataUtils.getAndroidID(context))));
