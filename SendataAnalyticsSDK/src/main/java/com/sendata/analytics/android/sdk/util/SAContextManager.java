...
public class SAContextManager {
    ...
    public Map<String, Object> getDeviceInfo() {
        try {
            if (mDeviceInfo == null && SendataAPI.getConfigOptions().isDataCollectEnable()) {
                setupDeviceInfo();
            }
        } catch (Exception ex) {
    ...
    public String getAndroidId() {
        if (TextUtils.isEmpty(mAndroidId) && SendataAPI.getConfigOptions().isDataCollectEnable()) {
            mAndroidId = SendataUtils.getAndroidID(mContext);
        }
        return mAndroidId;
    }
    ...
    private void setupDeviceInfo() {
        ...
        String osVersion = DeviceUtils.exec(SendataUtils.COMMAND_HARMONYOS_VERSION);
        ...
        deviceInfo.put("$lib_version", SendataAPI.sharedInstance().getSDKVersion());
