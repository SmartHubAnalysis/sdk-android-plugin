...
public class SendataAPIEmptyImplementation extends SendataAPI {
    SendataAPIEmptyImplementation() {
    ...
    @Override
    public void disableAutoTrack(SendataAPI.AutoTrackEventType autoTrackEventType) {
    ...
    @Deprecated
    @Override
    public void ignoreAutoTrackEventType(SendataAPI.AutoTrackEventType autoTrackEventType) {
    ...
    @Override
    public boolean isAutoTrackEventTypeIgnored(SendataAPI.AutoTrackEventType eventType) {
        return true;
    }
