...
public class SendataContentProvider extends ContentProvider {
    private static final UriMatcher uriMatcher = new UriMatcher(UriMatcher.NO_MATCH);
    private SendataDBHelper dbHelper;
        ...
        try {
            ...
            if (context != null) {
                ...
                try {
                    ...
                    packageName = "com.sendata.analytics.android.sdk.test";
                }
                dbHelper = new SendataDBHelper(context);
                mProviderHelper = new SAProviderHelper(context, dbHelper);
                mProviderHelper.appendUri(uriMatcher, packageName + ".SendataContentProvider");
                /* 迁移数据，并删除老的数据库 */
