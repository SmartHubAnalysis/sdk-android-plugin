...
import com.sendata.analytics.android.sdk.SendataAnalyticsAutoTrackEventType;
import com.sendata.analytics.android.sdk.encrypt.SecreteKey;

import org.json.JSONArray;
import org.json.JSONObject;

public class SendataSDKRemoteConfig {
    ...
    public void setAutoTrackMode(int autoTrackMode) {
        ...
        if ((this.autoTrackMode & SendataAnalyticsAutoTrackEventType.APP_START) == SendataAnalyticsAutoTrackEventType.APP_START) {
            this.mAutoTrackEventType |= SendataAnalyticsAutoTrackEventType.APP_START;
        }

        if ((this.autoTrackMode & SendataAnalyticsAutoTrackEventType.APP_END) == SendataAnalyticsAutoTrackEventType.APP_END) {
            this.mAutoTrackEventType |= SendataAnalyticsAutoTrackEventType.APP_END;
        }

        if ((this.autoTrackMode & SendataAnalyticsAutoTrackEventType.APP_CLICK) == SendataAnalyticsAutoTrackEventType.APP_CLICK) {
            this.mAutoTrackEventType |= SendataAnalyticsAutoTrackEventType.APP_CLICK;
        }

        if ((this.autoTrackMode & SendataAnalyticsAutoTrackEventType.APP_VIEW_SCREEN) == SendataAnalyticsAutoTrackEventType.APP_VIEW_SCREEN) {
            this.mAutoTrackEventType |= SendataAnalyticsAutoTrackEventType.APP_VIEW_SCREEN;
        }
    }
