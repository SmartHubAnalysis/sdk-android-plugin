...
package com.sendata.analytics.android.sdk.visual.property;
...
public class VisualPropertiesManager {
    ...
    public void requestVisualConfig() {
        Context context = SendataAPI.sharedInstance().getContext();
        if (context != null) {
    ...
    public void mergeVisualProperties(VisualEventType eventType, JSONObject srcObject, ViewNode viewNode) {
        try {
            ...
            if (!(activity != null && SendataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass()))) {
