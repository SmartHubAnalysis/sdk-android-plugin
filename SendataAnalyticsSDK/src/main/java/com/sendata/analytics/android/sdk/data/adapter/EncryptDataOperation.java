...
class EncryptDataOperation extends DataOperation {
    ...
    private SendataEncrypt mSendataEncrypt;

    EncryptDataOperation(Context context, SendataEncrypt sendataEncrypt) {
        super(context);
        this.mSendataEncrypt = sendataEncrypt;
    }
    ...
    int insertData(Uri uri, JSONObject jsonObject) {
        try {
            ...
            jsonObject = mSendataEncrypt.encryptTrackData(jsonObject);
