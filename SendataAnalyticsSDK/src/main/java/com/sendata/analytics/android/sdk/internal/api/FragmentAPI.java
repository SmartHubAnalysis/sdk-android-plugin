 ...
 */
package com.sendata.analytics.android.sdk.internal.api;
...
import com.sendata.analytics.android.sdk.SendataIgnoreTrackAppViewScreenAndAppClick;
...
public class FragmentAPI implements IFragmentAPI {
    ...
    public boolean isFragmentAutoTrackAppViewScreen(Class<?> fragment) {
        ...
        try {
            ...
            if (fragment.getAnnotation(SendataIgnoreTrackAppViewScreen.class) != null) {
                return false;
            }

            if (fragment.getAnnotation(SendataIgnoreTrackAppViewScreenAndAppClick.class) != null) {
                return false;
            }
