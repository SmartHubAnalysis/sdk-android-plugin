...
package com.sendata.analytics.android.sdk.visual.view;
...
public class PairingCodeRequestHelper {
    ...
    public void verifyPairingCodeRequest(final Context context, String paringCode, final IApiCallback callback) {
        try {
            ...
            final Uri uri = Uri.parse(SendataAPI.sharedInstance().getServerUrl());
            ...
            header.put("sendata-project", uri.getQueryParameter("project"));
                        ...
                        public void onResponse(JSONObject response) {
                            ...
                            if (isSuccess) {
                                ...
                                if (!TextUtils.isEmpty(urlString)) {
                                    SendataUtils.handleSchemeUrl((Activity) context, new Intent().setData(Uri.parse(urlString)));
                                }
                                if (callback != null) {
                                    callback.onSuccess();
                                }
