...
package com.sendata.analytics.android.sdk.encrypt;
...
public class SendataEncrypt {
    ...
    public SendataEncrypt(Context context, IPersistentSecretKey persistentSecretKey, List<SAEncryptListener> listeners) {
    ...
    private void saveLocalSecretKey(String key) {
        SharedPreferences preferences = SendataUtils.getSharedPreferences(mContext);
    ...
    private SecreteKey readLocalKey() throws JSONException {
        ...
        String symmetricEncryptType = null;
        String asymmetricEncryptType = null;
        final SharedPreferences preferences = SendataUtils.getSharedPreferences(mContext);
