...
class SendataDeepLink extends AbsDeepLink {
    ...
    public SendataDeepLink(Intent intent, String serverUrl) {
        super(intent);
            ...
            new RequestHelper.Builder(HttpMethod.GET, getRequestUrl())
                    ...
                    .callback(new HttpCallback.JsonCallback() {
                        ...
                        public void onAfter() {
                            ...
                            if (mCallBack != null) {
                                mCallBack.onFinish(DeepLinkManager.DeepLinkType.SENDATA, pageParams, success, duration);
                            }
                            SendataAPI.sharedInstance().trackInternal("$AppDeeplinkMatchedResult", properties);
                        }
                    }).execute();
        }
    }
