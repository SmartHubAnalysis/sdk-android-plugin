...
package com.sendata.analytics.android.sdk.visual.util;
...
import com.sendata.analytics.android.sdk.visual.snap.Pathfinder;
...
public class VisualUtil {
    ...
    public static void mergeRnScreenNameAndTitle(JSONObject jsonObject) {
        try {
            Class<?> rnViewUtils = ReflectUtil.getCurrentClass(new String[]{"com.sendata.analytics.utils.RNViewUtils"});
