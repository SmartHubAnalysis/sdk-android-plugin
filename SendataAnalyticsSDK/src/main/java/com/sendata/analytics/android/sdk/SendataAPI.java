...
import static com.sendata.analytics.android.sdk.util.SADataHelper.assertPropertyLength;
...
/**
 * Sendata Analytics SDK
 */
public class SendataAPI extends AbstractSendataAPI {
    // 可视化埋点功能最低 API 版本
    ...
    SendataAPI(Context context, SAConfigOptions configOptions, DebugMode debugMode) {
     ...
     * @return SendataAPI 单例
     */
    public static SendataAPI sharedInstance(Context context) {
        if (isSDKDisabled()) {
            return new SendataAPIEmptyImplementation();
        }
        ...
        synchronized (sInstanceMap) {
            ...
            SendataAPI instance = sInstanceMap.get(appContext);
    ...
    /**
     * 初始化并获取 SendataAPI 单例
     *
     * @param context App 的 Context
     * @param serverURL 用于收集事件的服务地址
     * @param debugMode Debug 模式,
     * {@link com.sendata.analytics.android.sdk.SendataAPI.DebugMode}
     * @return SendataAPI 单例
     */
    @Deprecated
    public static SendataAPI sharedInstance(Context context, String serverURL, DebugMode debugMode) {
     ...
     */
    @Deprecated
    public static SendataAPI sharedInstance(Context context, String serverURL) {
     ...
     */
    @Deprecated
    public static SendataAPI sharedInstance(Context context, SAConfigOptions saConfigOptions) {
        if (context == null || saConfigOptions == null) {
            throw new NullPointerException("Context、SAConfigOptions 不可以为 null");
        }
        SendataAPI sendataAPI = getInstance(context, DebugMode.DEBUG_OFF, saConfigOptions);
        if (!sendataAPI.mSDKConfigInit) {
            sendataAPI.applySAConfigOptions();
        }
        return sendataAPI;
    }
    ...
    private static SendataAPI getInstance(Context context, DebugMode debugMode,
        ...
        synchronized (sInstanceMap) {
            ...
            SendataAPI instance = sInstanceMap.get(appContext);
            if (null == instance) {
                instance = new SendataAPI(appContext, saConfigOptions, debugMode);
    ...
    public static SendataAPI sharedInstance() {
        if (isSDKDisabled()) {
            return new SendataAPIEmptyImplementation();
        }
        ...
        synchronized (sInstanceMap) {
            if (sInstanceMap.size() > 0) {
                Iterator<SendataAPI> iterator = sInstanceMap.values().iterator();
                if (iterator.hasNext()) {
                ...
                public void run() {
                    try {
                        if (mGPSLocation == null) {
                            mGPSLocation = new SendataGPSLocation();
                        }
        ...
        try {
            if (enable) {
                if (mOrientationDetector == null) {
                    mOrientationDetector = new SendataScreenOrientationDetector(mContext, SensorManager.SENSOR_DELAY_NORMAL);
                }
    ...
    public void showUpX5WebView(Object x5WebView, JSONObject properties, boolean isSupportJellyBean, boolean enableVerify) {
        try {
            ...
            addJavascriptInterface.invoke(x5WebView, new AppWebViewInterface(mContext, properties, enableVerify), "Sendata_APP_JS_Bridge");
            SendataAutoTrackHelper.addWebViewVisualInterface((View) x5WebView);
        } catch (Exception e) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
        }
    }
    ...
    public void showUpX5WebView(Object x5WebView, boolean enableVerify) {
        try {
            ...
            addJavascriptInterface.invoke(x5WebView, new AppWebViewInterface(mContext, null, enableVerify), "Sendata_APP_JS_Bridge");
            SendataAutoTrackHelper.addWebViewVisualInterface((View) x5WebView);
        } catch (Exception e) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
        }
    ...
    public boolean isActivityAutoTrackAppViewScreenIgnored(Class<?> activity) {
        ...
        if (activity.getAnnotation(SendataIgnoreTrackAppViewScreenAndAppClick.class) != null) {
            return true;
        }

        return activity.getAnnotation(SendataIgnoreTrackAppViewScreen.class) != null;
    }
    ...
    public boolean isActivityAutoTrackAppClickIgnored(Class<?> activity) {
        ...
        return activity.getAnnotation(SendataIgnoreTrackAppClick.class) != null;
    ...
    public void setViewID(View view, String viewID) {
        if (view != null && !TextUtils.isEmpty(viewID)) {
            view.setTag(R.id.sendata_analytics_tag_view_id, viewID);
        }
    }
        ...
        try {
            if (view != null && !TextUtils.isEmpty(viewID)) {
                if (view.getWindow() != null) {
                    view.getWindow().getDecorView().setTag(R.id.sendata_analytics_tag_view_id, viewID);
                }
            }
        } catch (Exception e) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
    ...
    public void setViewID(Object alertDialog, String viewID) {
        try {
            ...
            if (!TextUtils.isEmpty(viewID)) {
                ...
                if (window != null) {
                    window.getDecorView().setTag(R.id.sendata_analytics_tag_view_id, viewID);
                }
            }
        } catch (Exception e) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
    ...
    public void setViewActivity(View view, Activity activity) {
        try {
            ...
            view.setTag(R.id.sendata_analytics_tag_view_activity, activity);
        } catch (Exception e) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
        }
    }
    ...
    public void setViewFragmentName(View view, String fragmentName) {
        try {
            ...
            view.setTag(R.id.sendata_analytics_tag_view_fragment_name2, fragmentName);
        } catch (Exception e) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
        }
    }
    ...
    public void ignoreView(View view) {
        if (view != null) {
            view.setTag(R.id.sendata_analytics_tag_view_ignored, "1");
        }
    }
    ...
    public void ignoreView(View view, boolean ignore) {
        if (view != null) {
            view.setTag(R.id.sendata_analytics_tag_view_ignored, ignore ? "1" : "0");
        }
    }
    ...
    public void setViewProperties(View view, JSONObject properties) {
        ...
        view.setTag(R.id.sendata_analytics_tag_view_properties, properties);
    }
            ...
            mTrackTaskManager.addTrackEventTask(new Runnable() {
                ...
                public void run() {
                    synchronized (mDistinctId) {
                        ...
                        if (SendataUtils.isValidAndroidId(androidId)) {
    ...
    public void trackInstallation(final String eventName, final JSONObject properties, final boolean disableCallback) {
        ...
        if (properties != null) {
            SendataUtils.mergeJSONObject(properties, eventProperties);
        }
            ...
            public void run() {
                ...
                try {
                    ...
                    if (firstTrackInstallation) {
                        ...
                        SendataUtils.mergeJSONObject(eventProperties, profileProperties);
            ...
            public void run() {
                try {
                    if (!TextUtils.isEmpty(url) || properties != null) {
                        ...
                        if (properties != null) {
                            SendataUtils.mergeJSONObject(properties, trackProperties);
                        }
        ...
        mTrackTaskManager.addTrackEventTask(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    trackViewScreen(SendataUtils.getScreenUrl(activity), properties);
                } catch (Exception e) {
                    SALog.printStackTrace(e);
                }
            }
        ...
        mTrackTaskManager.addTrackEventTask(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (fragment.getClass().isAnnotationPresent(SendataFragmentTitle.class)) {
                        SendataFragmentTitle sendataFragmentTitle = fragment.getClass().getAnnotation(SendataFragmentTitle.class);
                        if (sendataFragmentTitle != null) {
                            title = sendataFragmentTitle.title();
                        }
                    }
                    ...
                    if (Build.VERSION.SDK_INT >= 11) {
                        ...
                        if (activity != null) {
                            if (TextUtils.isEmpty(title)) {
                                title = SendataUtils.getActivityTitle(activity);
                            }
                    ...
                    trackViewScreen(SendataUtils.getScreenUrl(fragment), properties);
                } catch (Exception e) {
                    com.sendata.analytics.android.sdk.SALog.printStackTrace(e);
                }
            }
    ...
    @Override
    public void registerDynamicSuperProperties(SendataDynamicSuperProperties dynamicSuperProperties) {
        mDynamicSuperPropertiesCallBack = dynamicSuperProperties;
    }

    @Override
    public void setTrackEventCallBack(SendataTrackEventCallBack trackEventCallBack) {
        mTrackEventCallBack = trackEventCallBack;
    }

    @Override
    public void setDeepLinkCallback(SendataDeepLinkCallback deepLinkCallback) {
            ...
            public void run() {
                try {
                    ...
                    synchronized (mSuperProperties) {
                        ...
                        mSuperProperties.commit(SendataUtils.mergeSuperJSONObject(superProperties, properties));
                    }
                } catch (Exception e) {
                    SALog.printStackTrace(e);
                }
    ...
    public void setServerUrl(final String serverUrl, boolean isRequestRemoteConfig) {
        try {
            ...
            if (isRequestRemoteConfig && mRemoteManager != null) {
                try {
                    mRemoteManager.requestRemoteConfig(BaseSendataSDKRemoteManager.RandomTimeType.RandomTimeTypeWrite, false);
                } catch (Exception e) {
                    SALog.printStackTrace(e);
                }
            }
        ...
        transformTaskQueue(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    SharedPreferences sp = SendataUtils.getSharedPreferences(mContext);
    ...
    /**
     * Debug 模式，用于检验数据导入是否正确。该模式下，事件会逐条实时发送到 Sendata Analytics，并根据返回值检查
     * 数据导入是否正确。
     * Debug 模式的具体使用方式，请参考:
     * http://www.sendata.cn/manual/debug_mode.html
     * Debug 模式有三种：
     * DEBUG_OFF - 关闭DEBUG模式
     * DEBUG_ONLY - 打开DEBUG模式，但该模式下发送的数据仅用于调试，不进行数据导入
     * DEBUG_AND_TRACK - 打开DEBUG模式，并将数据导入到SendataAnalytics中
     */
