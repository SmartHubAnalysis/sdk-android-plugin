...
public class PairingCodeEditDialog extends Dialog {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sendata_analytics_verification_code);
        ...
        final PairingCodeEditText pairingCodeEditText = findViewById(R.id.sendata_analytics_pairing_code);
