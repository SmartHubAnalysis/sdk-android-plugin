...
import com.sendata.analytics.android.sdk.data.persistent.PersistentFlushDataState;
...
class SAProviderHelper {
    ...
    public void migratingDB(final Context context, final String packageName) {
        try {
            boolean isMigrating = AppInfoUtils.getAppInfoBundle(context).getBoolean("com.sendata.analytics.android.EnableMigratingDB", true);
            if (!isMigrating) {
                return;
            }
        ...
        try {
            ...
            switch (code) {
                ...
                case URI_CODE.LOGIN_ID:
                    ...
                    break;
                case URI_CODE.FLUSH_DATA:
                    synchronized (SendataContentProvider.class) {
