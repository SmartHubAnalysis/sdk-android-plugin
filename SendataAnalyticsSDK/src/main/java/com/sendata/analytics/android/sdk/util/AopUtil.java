...
import com.sendata.analytics.android.sdk.R;
import com.sendata.analytics.android.sdk.SALog;
import com.sendata.analytics.android.sdk.ScreenAutoTracker;
import com.sendata.analytics.android.sdk.SendataAPI;
import com.sendata.analytics.android.sdk.SendataFragmentTitle;
import com.sendata.analytics.android.sdk.visual.ViewTreeStatusObservable;
...
public class AopUtil {
        ...
        try {
            if (context != null) {
                if (context instanceof Activity) {
                    ...
                    if (view != null) {
                        Object object = view.getTag(R.id.sendata_analytics_tag_view_activity);
                        if (object != null) {
        ...
        try {
            ...
            if (fragment instanceof ScreenAutoTracker) {
                ...
                if (trackProperties != null) {
                    ...
                    SendataUtils.mergeJSONObject(trackProperties, properties);
                }
            }

            if (TextUtils.isEmpty(title) && fragment.getClass().isAnnotationPresent(SendataFragmentTitle.class)) {
    ...
    public static JSONObject buildTitleAndScreenName(Activity activity) {
        ...
        try {
            ...
            if (activity instanceof ScreenAutoTracker) {
                ...
                JSONObject trackProperties = screenAutoTracker.getTrackProperties();
                if (trackProperties != null) {
                    SendataUtils.mergeJSONObject(trackProperties, propertyJSON);
                }
            }
        } catch (Exception ex) {
            com.sendata.analytics.android.sdk.SALog.printStackTrace(ex);
    ...
    public static String getViewId(View view) {
        ...
        try {
            idString = (String) view.getTag(R.id.sendata_analytics_tag_view_id);
    ...
    public static boolean isViewIgnored(Class viewType) {
        try {
            ...
            List<Class> mIgnoredViewTypeList = SendataAPI.sharedInstance().getIgnoredViewTypeList();
    ...
    public static boolean isViewIgnored(View view) {
        try {
            ...
            //View 被忽略
            return "1".equals(view.getTag(R.id.sendata_analytics_tag_view_ignored));
        ...
        try {
            if (activity != null) {
                try {
                    ...
                    if (Build.VERSION.SDK_INT >= 11) {
                        String toolbarTitle = SendataUtils.getToolbarTitle(activity);
     ...
     * {@link SendataAPI#setViewProperties(View, JSONObject)} 低于
     * {@link SendataAPI#trackViewAppClick(View, JSONObject)}
     *
     * @param view 点击的 view
    ...
    public static boolean injectClickInfo(View view, JSONObject properties, boolean isFromUser) {
        ...
        try {
            ...
            if (activity != null) {
                SendataUtils.mergeJSONObject(AopUtil.buildTitleAndScreenName(activity), eventJson);
            }
    ...
    public static Object getFragmentFromView(View view, Activity activity) {
        try {
            if (view != null) {
                String fragmentName = (String) view.getTag(R.id.sendata_analytics_tag_view_fragment_name);
                String fragmentName2 = (String) view.getTag(R.id.sendata_analytics_tag_view_fragment_name2);
                ...
                if (TextUtils.isEmpty(fragmentName)) {
                    ...
                    if (activity != null) {
                        ...
                        if (window != null && window.isActive()) {
                            Object tag = window.getDecorView().getRootView().getTag(R.id.sendata_analytics_tag_view_fragment_name);
                            if (tag != null) {
    ...
    public static ViewNode addViewPathProperties(Activity activity, View view, JSONObject properties) {
        try {
            ...
            if ((SendataAPI.sharedInstance().isHeatMapEnabled() || SendataAPI.sharedInstance().isVisualizedAutoTrackEnabled())
                    && (SendataAPI.sharedInstance().isHeatMapActivity(activity.getClass()) || SendataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass()))) {
            ...
            if (viewNode != null) {
                if (!TextUtils.isEmpty(viewNode.getViewPath())) {
                    if ((SendataAPI.sharedInstance().isVisualizedAutoTrackEnabled() && SendataAPI.sharedInstance().isVisualizedAutoTrackActivity(activity.getClass()))
                            || (SendataAPI.sharedInstance().isHeatMapEnabled() && SendataAPI.sharedInstance().isHeatMapActivity(activity.getClass()))) {
    ...
    private static String traverseParentViewTag(View view) {
        try {
            ...
            while (TextUtils.isEmpty(fragmentName) && parentView instanceof View) {
                fragmentName = (String) ((View) parentView).getTag(R.id.sendata_analytics_tag_view_fragment_name);
