...
package com.sendata.analytics.android.sdk.aop.push;
...
public class PushAutoTrackHelper {
    ...
    public static void trackJPushOpenActivity(Intent intent) {
        ...
        if (!SendataAPI.getConfigOptions().mEnableTrackPush) {
    ...
    private static void trackNotificationOpenedEvent(String sfData,
        ...
        try {
            ...
            SendataAPI.sharedInstance().track("$AppPushClick", eventProperties);
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
    }
