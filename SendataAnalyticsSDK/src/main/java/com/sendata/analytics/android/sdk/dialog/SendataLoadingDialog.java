...
public class SendataLoadingDialog extends Dialog {

    private RelativeLayout mLoadingLayout;

    public SendataLoadingDialog(Context context) {
        super(context);
    }
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.sendata_analytics_dialog_loading);
    ...
    private void initView() {
        mLoadingLayout = findViewById(R.id.sendata_analytics_rotate_layout);
        ImageView imageView1 = findViewById(R.id.sendata_analytics_loading_image1);
        ImageView imageView2 = findViewById(R.id.sendata_analytics_loading_image2);
        ImageView imageView3 = findViewById(R.id.sendata_analytics_loading_image3);
        ImageView imageView4 = findViewById(R.id.sendata_analytics_loading_image4);
