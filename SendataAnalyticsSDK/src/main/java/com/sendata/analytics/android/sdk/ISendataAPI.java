...
public interface ISendataAPI extends IFragmentAPI {
    /**
     * 返回预置属性
     *
     ...
     * https://sendata.cn/manual/android_sdk.html
     ...
     */
    void enableAutoTrack(List<SendataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    void disableAutoTrack(List<SendataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    void disableAutoTrack(SendataAPI.AutoTrackEventType autoTrackEventType);
     ...
     */
    @Deprecated
    void ignoreAutoTrackEventType(SendataAPI.AutoTrackEventType autoTrackEventType);
     ...
     */
    @Deprecated
    void ignoreAutoTrackEventType(List<SendataAPI.AutoTrackEventType> eventTypeList);
     ...
     */
    boolean isAutoTrackEventTypeIgnored(SendataAPI.AutoTrackEventType eventType);

    /**
     * 判断某个 AutoTrackEventType 是否被忽略
     *
     * @param autoTrackEventType SendataAnalyticsAutoTrackEventType 中的事件类型，可通过 '|' 进行连接传递
     * @return true 被忽略; false 没有被忽略
     */
    ...
    /**
     * 获取当前用户的匿名 ID
     * 若调用前未调用 {@link #identify(String)} 设置用户的匿名 ID，SDK 会优先调用 {@link com.sendata.analytics.android.sdk.util.SendataUtils#getAndroidID(Context)}获取 Android ID，
     ...
     * http://www.sendata.cn/manual/track_signup.html
     * 并在必要时联系我们的技术支持人员。
     ...
     * 这是 Sendata Analytics 进阶功能，请参考文档 https://sendata.cn/manual/track_installation.html
     *
    ...
    /**
     * 将所有本地缓存的日志发送到 Sendata Analytics.
     */
    void flush();
    ...
    /**
     * 以轮询形式将所有本地缓存的日志发送到 Sendata Analytics.
     */
    void flushScheduled();
     ...
     */
    void registerDynamicSuperProperties(SendataDynamicSuperProperties dynamicSuperProperties);
     ...
     */
    void setTrackEventCallBack(SendataTrackEventCallBack trackEventCallBack);
     ...
     */
    void setDeepLinkCallback(SendataDeepLinkCallback deepLinkCallback);
     ...
     * @param latitude 纬度
     * @param longitude 经度
     * @param coordinate 坐标系，坐标系类型请参照 {@link SendataGPSLocation.CoordinateType}
     */
