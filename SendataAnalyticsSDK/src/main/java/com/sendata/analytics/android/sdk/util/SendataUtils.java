...
import com.sendata.analytics.android.sdk.SendataAutoTrackAppViewScreenUrl;
...
public final class SendataUtils {

    private static final String marshmallowMacAddress = "02:00:00:00:00:00";

    private static final String SHARED_PREF_EDITS_FILE = "sendata";
    private static final String SHARED_PREF_USER_AGENT_KEY = "sendata.user.agent";
    private static final String SHARED_PREF_APP_VERSION = "sendata.app.version";
    private static final String SHARED_PREF_DEVICE_ID_KEY = "sendata.device.id";
    ...
    private static final String TAG = "SA.SendataUtils";
    ...
    public static String getCarrier(Context context) {
        try {
            if (SendataUtils.checkHasPermission(context, Manifest.permission.READ_PHONE_STATE)) {
                try {
    ...
    private static boolean hasReadPhoneStatePermission(Context context) {
        if (Build.VERSION.SDK_INT > Build.VERSION_CODES.P) {
            if (!SendataUtils.checkHasPermission(context, Manifest.permission.READ_PRECISE_PHONE_STATE)) {
                SALog.i(TAG, "Don't have permission android.permission.READ_PRECISE_PHONE_STATE,getDeviceID failed");
                return false;
            }
        } else if (!SendataUtils.checkHasPermission(context, Manifest.permission.READ_PHONE_STATE)) {
    ...
    public static boolean isDoubleClick(View view) {
        ...
        try {
            ...
            String tag = (String) view.getTag(R.id.sendata_analytics_tag_view_onclick_timestamp);
            ...
            view.setTag(R.id.sendata_analytics_tag_view_onclick_timestamp, String.valueOf(currentOnClickTimestamp));
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
        return false;
    ...
    public static String getScreenUrl(Object object) {
        ...
        try {
            if (object instanceof ScreenAutoTracker) {
                ...
                SendataAutoTrackAppViewScreenUrl autoTrackAppViewScreenUrl = object.getClass().getAnnotation(SendataAutoTrackAppViewScreenUrl.class);
     ...
     * 此方法用来辅助完善 Dialog 的展示，通常用在配置了Smarthub scheme 的 Activity 页面中的 onNewIntent 方法中，
