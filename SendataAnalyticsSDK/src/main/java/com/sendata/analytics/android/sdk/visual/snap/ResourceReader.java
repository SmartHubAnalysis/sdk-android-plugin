...
package com.sendata.analytics.android.sdk.visual.snap;
        ...
        try {
            ...
            SALog.i(TAG,
                    "You may be missing a Resources class for your package due to your proguard configuration, "
                            ...
                            + " to explicitly point the Sendata library to the appropriate library for your"
                            + " resources class:\n\n"
                            + "<meta-data android:name=\"com.sendata.analytics.android.ResourcePackageName\""
