...
package com.sendata.analytics.android.sdk.data.persistent;
...
public class PersistentLoader {
    ...
    private PersistentLoader(Context context) {
        ...
        final String prefsName = "com.sendata.analytics.android.sdk.SendataAPI";
    ...
    public interface PersistentName {
        ...
        String REMOTE_CONFIG = "sendata_sdk_configuration";
