...
public class AppStateManager implements Application.ActivityLifecycleCallbacks {
    ...
    public void onActivityResumed(Activity activity) {
        ...
        if (SendataAPI.sharedInstance().isVisualizedAutoTrackEnabled() && Build.VERSION.SDK_INT >= 16) {
            if (decorView != null) {
    ...
    private void unRegisterViewTreeChange(View root) {
        try {
            if (root.getTag(R.id.sendata_analytics_tag_view_tree_observer_listeners) != null) {
                ...
                root.setTag(R.id.sendata_analytics_tag_view_tree_observer_listeners, null);
            }
        } catch (Exception e) {
    ...
    private void monitorViewTreeChange(View root) {
        try {
            if (root.getTag(R.id.sendata_analytics_tag_view_tree_observer_listeners) == null) {
                ...
                root.setTag(R.id.sendata_analytics_tag_view_tree_observer_listeners, true);
            }
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
