...
import com.sendata.analytics.android.sdk.visual.WebViewVisualInterface;
...
public class SendataAutoTrackHelper {
    private static final String TAG = "SendataAutoTrackHelper";
    ...
    private static void traverseView(String fragmentName, ViewGroup root) {
        try {
            ...
            for (int i = 0; i < childCount; ++i) {
                ...
                child.setTag(R.id.sendata_analytics_tag_view_fragment_name, fragmentName);
    ...
    public static void onFragmentViewCreated(Object object, View rootView, Bundle bundle) {
        try {
            ...
            rootView.setTag(R.id.sendata_analytics_tag_view_fragment_name, fragmentName);
            ...
            if (activity != null) {
                ...
                if (window != null && window.isActive()) {
                    window.getDecorView().getRootView().setTag(R.id.sendata_analytics_tag_view_fragment_name, "");
                }
            }
        } catch (Exception e) {
            SALog.printStackTrace(e);
    ...
    public static void trackRN(Object target, int reactTag, int s, boolean b) {
        try {
            if (!SendataAPI.sharedInstance().isReactNativeAutoTrackEnabled()) {
                return;
            }

            //关闭 AutoTrack
            if (!SendataAPI.sharedInstance().isAutoTrackEnabled()) {
                return;
            }

            //$AppClick 被过滤
            if (SendataAPI.sharedInstance().isAutoTrackEventTypeIgnored(SendataAPI.AutoTrackEventType.APP_CLICK)) {
                return;
            }
            ...
            if (target != null) {
                ...
                if (resolveViewMethod != null) {
                    ...
                    if (object != null) {
                        ...
                        //$screen_name & $title
                        if (activity != null) {
                            SendataUtils.mergeJSONObject(AopUtil.buildTitleAndScreenName(activity), properties);
            ...
            SendataAPI.sharedInstance().trackAutoEvent(AopConstants.APP_CLICK_EVENT_NAME, properties, viewNode);
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
    }
    ...
    private static void trackFragmentAppViewScreen(Object fragment) {
        try {
            if (SendataAPI.sharedInstance().isAutoTrackEventTypeIgnored(SendataAPI.AutoTrackEventType.APP_VIEW_SCREEN)) {
                return;
            }

            if (!SendataAPI.sharedInstance().isTrackFragmentAppViewScreenEnabled()) {
                return;
            }
            ...
            boolean isAutoTrackFragment = SendataAPI.sharedInstance().isFragmentAutoTrackAppViewScreen(fragment.getClass());
            ...
            SendataAPI.sharedInstance().trackViewScreen(SendataUtils.getScreenUrl(fragment), eventProperties);
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
    }
    ...
    public static void trackExpandableListViewOnGroupClick(ExpandableListView expandableListView, View view,
        ...
        try {
            ...
            //Activity 被忽略
            if (activity != null) {
                if (SendataAPI.sharedInstance().isActivityAutoTrackAppClickIgnored(activity.getClass())) {
                    return;
                }
            }
            ...
            // fragment 忽略
            if (fragment != null) {
                if (SendataAPI.sharedInstance().isActivityAutoTrackAppClickIgnored(fragment.getClass())) {
                    return;
                }
            }
            ...
            // 获取 View 自定义属性
            JSONObject p = (JSONObject) view.getTag(R.id.sendata_analytics_tag_view_properties);
            if (p != null) {
            ...
            if (listAdapter != null) {
                if (listAdapter instanceof SendataExpandableListViewItemTrackProperties) {
                    try {
                        SendataExpandableListViewItemTrackProperties trackProperties = (SendataExpandableListViewItemTrackProperties) listAdapter;
                        JSONObject jsonObject = trackProperties.getSendataGroupItemTrackProperties(groupPosition);
                        if (jsonObject != null) {
    ...
    public static void trackExpandableListViewOnChildClick(ExpandableListView expandableListView, View view,
        ...
        try {
            ...
            //获取 View 自定义属性
            JSONObject properties = (JSONObject) view.getTag(R.id.sendata_analytics_tag_view_properties);
            ...
            if (listAdapter != null) {
                if (listAdapter instanceof SendataExpandableListViewItemTrackProperties) {
                    SendataExpandableListViewItemTrackProperties trackProperties = (SendataExpandableListViewItemTrackProperties) listAdapter;
                    JSONObject jsonObject = trackProperties.getSendataChildItemTrackProperties(groupPosition, childPosition);
                    if (jsonObject != null) {
                        AopUtil.mergeJSONObject(jsonObject, properties);
                    }
                }
    ...
    public static void trackTabLayoutSelected(Object object, Object tab) {
        try {
            ...
            if (isFragment) {
                if (SendataAPI.sharedInstance().isActivityAutoTrackAppClickIgnored(object.getClass())) {
                    return;
                }
            }
    ...
    public static void trackDialog(DialogInterface dialogInterface, int whichButton) {
        try {
            ...
            try {
                ...
                if (window != null && window.isActive()) {
                    String idString = (String) dialog.getWindow().getDecorView().getTag(R.id.sendata_analytics_tag_view_id);
                    if (!TextUtils.isEmpty(idString)) {
                        properties.put(AopConstants.ELEMENT_ID, idString);
                    }
                }
    ...
    public static void trackListView(AdapterView<?> adapterView, View view, int position) {
        try {
            ...
            if (adapter instanceof SendataAdapterViewItemTrackProperties) {
                try {
                    SendataAdapterViewItemTrackProperties objectProperties = (SendataAdapterViewItemTrackProperties) adapter;
                    JSONObject jsonObject = objectProperties.getSendataItemTrackProperties(position);
                    if (jsonObject != null) {
                        AopUtil.mergeJSONObject(jsonObject, properties);
                    }
                } catch (JSONException e) {
    ...
    public static void trackDrawerOpened(View view) {
        try {
            ...
            SendataAPI.sharedInstance().setViewProperties(view, jsonObject);
    ...
    public static void trackViewOnClick(View view, boolean isFromUser) {
        try {
            ...
            if (SendataUtils.isDoubleClick(view)) {
                return;
            }
            ...
            if (AopUtil.injectClickInfo(view, properties, isFromUser)) {
                SendataAPI.sharedInstance().trackAutoEvent(AopConstants.APP_CLICK_EVENT_NAME, properties, AopUtil.addViewPathProperties(activity, view, properties));
            }
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
    ...
    public static void track(String eventName, String properties) {
        try {
            ...
            SendataAPI.sharedInstance().trackInternal(eventName, pro);
        } catch (Exception e) {
            SALog.printStackTrace(e);
        }
    }
    ...
    public static void showChannelDebugActiveDialog(final Activity activity) {
        SendataDialogUtils.showDialog(activity, "成功开启调试模式",
                "此模式下不需要卸载 App，点击“激活”按钮可反复触发激活", "激活", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        SendataAPI.sharedInstance().trackChannelDebugInstallation();
    ...
    private static void setupH5Bridge(View webView) {
        if (SendataAPI.sharedInstance() instanceof SendataAPIEmptyImplementation) {
            return;
        }
        if (isSupportJellyBean() && SendataAPI.sharedInstance().getConfigOptions() != null && SendataAPI.sharedInstance().getConfigOptions().isAutoTrackWebView) {
    ...
    static void addWebViewVisualInterface(View webView) {
        if (webView != null && webView.getTag(R.id.sendata_analytics_tag_view_webview_visual) == null) {
            webView.setTag(R.id.sendata_analytics_tag_view_webview_visual, new Object());
            addJavascriptInterface(webView, new WebViewVisualInterface(webView), "Sendata_App_Visual_Bridge");
        }
    }

    private static boolean isSupportJellyBean() {
        if (Build.VERSION.SDK_INT < Build.VERSION_CODES.JELLY_BEAN_MR1 && !SendataAPI.sharedInstance().getConfigOptions().isWebViewSupportJellyBean) {
    ...
    private static void setupWebView(View webView) {
        if (webView != null && webView.getTag(R.id.sendata_analytics_tag_view_webview) == null) {
            webView.setTag(R.id.sendata_analytics_tag_view_webview, new Object());
            addJavascriptInterface(webView, new AppWebViewInterface(SendataAPI.sharedInstance().getContext(), null, false, webView), "Sendata_APP_New_H5_Bridge");
        }
    }
